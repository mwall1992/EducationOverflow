...
<asp:Content ID="Content3" ContentPlaceHolderID="main_content_body_content" runat="server">
    <asp:DetailsView ID="FeedbackDetailsView" runat="server" AutoGenerateRows="False" DataSourceID="QuestionFeedbackDetailsDataSource" AutoGenerateDeleteButton="True">
        <Fields>
