...
<asp:Content ID="Content3" ContentPlaceHolderID="main_content_body_content" runat="server">
    <asp:DetailsView ID="ReportedQuestionDetailsView" runat="server" AutoGenerateRows="False" DataSourceID="ReportedQuestionDetailsDataSource" AutoGenerateDeleteButton="True">
        <Fields>
